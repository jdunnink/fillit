...
/*   Updated: 2019/05/08 11:30:40 by jdunnink      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
static int		validate_input(size_t *count, char *buff, uint16_t *dst,
t_list **list)
{
	char	**tetro;
	size_t	total;
...
static int		read_tetri(int fd, size_t *count, uint16_t *dst, t_list **list)
{
	int		nbr;
	char	buff[22];
	int		pnbr;
